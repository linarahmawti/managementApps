...
<div class="container mx-auto px-4 py-6">
    <div class="bg-white rounded-lg shadow-md p-6">
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-800">Edit Progress Report</h1>
        </div>

        <form action="{{ route('karyawan.reports.update', $report) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
                    ...
                    <div>
                        ...
                        <select name="assignment_id" id="assignment_id"
                            ...
                            @foreach($assignments as $assignment)
                                <option value="{{ $assignment->id }}" {{ old('assignment_id', $report->assignment_id) == $assignment->id ? 'selected' : '' }}>
            ...
            <div class="bg-gray-50 p-4 rounded-lg">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="nama_barang" id="nama_barang" value="{{ old('nama_barang', $report->nama_barang) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="lokasi_pengantaran" id="lokasi_pengantaran" value="{{ old('lokasi_pengantaran', $report->lokasi_pengantaran) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                    ...
                    <div>
                        ...
                        <input type="number" name="jumlah_diantar" id="jumlah_diantar" value="{{ old('jumlah_diantar', $report->jumlah_diantar) }}"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="harga_total" id="harga_total" value="{{ old('harga_total', $report->harga_total) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="status_pengantaran" id="status_pengantaran"
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                            <option value="belum_dikirim" {{ old('status_pengantaran', $report->status_pengantaran) == 'belum_dikirim' ? 'selected' : '' }}>
                                Belum Dikirim
                            </option>
                            <option value="dalam_perjalanan" {{ old('status_pengantaran', $report->status_pengantaran) == 'dalam_perjalanan' ? 'selected' : '' }}>
                                Dalam Perjalanan
                            </option>
                            <option value="selesai" {{ old('status_pengantaran', $report->status_pengantaran) == 'selesai' ? 'selected' : '' }}>
                                Selesai
                            </option>
                        </select>
                    ...
                    <div>
                        ...
                        <input type="datetime-local" name="tanggal_laporan" id="tanggal_laporan"
                               value="{{ old('tanggal_laporan', $report->tanggal_laporan->format('Y-m-d\TH:i')) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="catatan" id="catatan" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('catatan', $report->catatan) }}</textarea>
                        @error('catatan')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
